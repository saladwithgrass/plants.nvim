...
M.set_highlight = function(colors, config)
  ...
  nvim_set_hl('EndOfBuffer', { fg = colors.base02 })
  ...
  --   { transparent = config.transparent.enabled }
  -- )
  nvim_set_hl('IncSearch', { fg = colors.green, bg = colors.mix_green })
  ...
  nvim_set_hl('MatchParen', { fg = colors.cyan, bg = colors.base00 })
